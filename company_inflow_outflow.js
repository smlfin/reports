...
function generateReport() {
    ...
    // --- Calculate Overall Summary (April 2025 - Current Month) ---
    // This calculation should always be based on the initially filtered `allData` (within the fixed date range),
    // NOT the `filteredData` which can be constrained by month/company selections.
    let overallInflow = 0;
    let overallOutflow = 0;
    allData.forEach(row => { // Use allData here for overall calculations
